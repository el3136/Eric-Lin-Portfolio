      ...
      <RevealOnScroll>
        <div className='text-center z-10 px-4'>
          ...
          <p className='text-gray-400 text-lg mb-8 max-w-lg mx-auto'>
            I'm a full-stack developer who loves writing clean, scalable web applications. My goal is to build solutions that offer both exceptional performance and delightful user experience.
          </p>
